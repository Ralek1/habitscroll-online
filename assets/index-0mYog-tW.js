const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Index-DC0sqVUV.js","./components-Di1uasbc.js","./react-vendor-BMCMh-XC.js","./ui-vendor-CwutIfTV.js","./icons-Og7bbhG8.js","./pages-CgsJvD3g.js"])))=>i.map(i=>d[i]);
import{r as _,j as p,q as Gr,H as Jr,d as Yr,e as w,f as Xr}from"./react-vendor-BMCMh-XC.js";import{a as Qr,_ as E,b as Zr,T as ei}from"./components-Di1uasbc.js";import{N as ti}from"./pages-CgsJvD3g.js";import"./ui-vendor-CwutIfTV.js";import"./icons-Og7bbhG8.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}})();var Wt={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v=new wt("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hc(t){if(!t.startsWith(xt)){const e=b.create("invalid-gtag-resource",{gtagURL:t});return v.warn(e.message),""}return t}function jr(t){return Promise.all(t.map(e=>e.catch(n=>n)))}function Wc(t,e){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(t,e)),n}function zc(t,e){const n=Wc("firebase-js-sdk-policy",{createScriptURL:Hc}),r=document.createElement("script"),i=`${xt}?l=${t}&id=${e}`;r.src=n?n==null?void 0:n.createScriptURL(i):i,r.async=!0,document.head.appendChild(r)}function qc(t){let e=[];return Array.isArray(window[t])?e=window[t]:window[t]=e,e}async function Kc(t,e,n,r,i,s){const o=r[i];try{if(o)await e[o];else{const c=(await jr(n)).find(l=>l.measurementId===i);c&&await e[c.appId]}}catch(a){v.error(a)}t("config",i,s)}async function Gc(t,e,n,r,i){try{let s=[];if(i&&i.send_to){let o=i.send_to;Array.isArray(o)||(o=[o]);const a=await jr(n);for(const c of o){const l=a.find(h=>h.measurementId===c),u=l&&e[l.appId];if(u)s.push(u);else{s=[];break}}}s.length===0&&(s=Object.values(e)),await Promise.all(s),t("event",r,i||{})}catch(s){v.error(s)}}function Jc(t,e,n,r){async function i(s,...o){try{if(s==="event"){const[a,c]=o;await Gc(t,e,n,a,c)}else if(s==="config"){const[a,c]=o;await Kc(t,e,n,r,a,c)}else if(s==="consent"){const[a]=o;t("consent","update",a)}else if(s==="get"){const[a,c,l]=o;t("get",a,c,l)}else if(s==="set"){const[a]=o;t("set",a)}else t(s,...o)}catch(a){v.error(a)}}return i}function Yc(t,e,n,r,i){let s=function(...o){window[r].push(arguments)};return window[i]&&typeof window[i]=="function"&&(s=window[i]),window[i]=Jc(s,t,e,n),{gtagCore:s,wrappedGtag:window[i]}}function Xc(t){const e=window.document.getElementsByTagName("script");for(const n of Object.values(e))if(n.src&&n.src.includes(xt)&&n.src.includes(t))return n;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qc=30,Zc=1e3;class el{constructor(e={},n=Zc){this.throttleMetadata=e,this.intervalMillis=n}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,n){this.throttleMetadata[e]=n}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const Vr=new el;function tl(t){return new Headers({Accept:"application/json","x-goog-api-key":t})}async function nl(t){var e;const{appId:n,apiKey:r}=t,i={method:"GET",headers:tl(r)},s=jc.replace("{app-id}",n),o=await fetch(s,i);if(o.status!==200&&o.status!==304){let a="";try{const c=await o.json();!((e=c.error)===null||e===void 0)&&e.message&&(a=c.error.message)}catch{}throw b.create("config-fetch-failed",{httpStatus:o.status,responseMessage:a})}return o.json()}async function rl(t,e=Vr,n){const{appId:r,apiKey:i,measurementId:s}=t.options;if(!r)throw b.create("no-app-id");if(!i){if(s)return{measurementId:s,appId:r};throw b.create("no-api-key")}const o=e.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},a=new ol;return setTimeout(async()=>{a.abort()},$c),Hr({appId:r,apiKey:i,measurementId:s},o,a,e)}async function Hr(t,{throttleEndTimeMillis:e,backoffCount:n},r,i=Vr){var s;const{appId:o,measurementId:a}=t;try{await il(r,e)}catch(c){if(a)return v.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:o,measurementId:a};throw c}try{const c=await nl(t);return i.deleteThrottleMetadata(o),c}catch(c){const l=c;if(!sl(l)){if(i.deleteThrottleMetadata(o),a)return v.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:o,measurementId:a};throw c}const u=Number((s=l==null?void 0:l.customData)===null||s===void 0?void 0:s.httpStatus)===503?qt(n,i.intervalMillis,Qc):qt(n,i.intervalMillis),h={throttleEndTimeMillis:Date.now()+u,backoffCount:n+1};return i.setThrottleMetadata(o,h),v.debug(`Calling attemptFetch again in ${u} millis`),Hr(t,h,r,i)}}function il(t,e){return new Promise((n,r)=>{const i=Math.max(e-Date.now(),0),s=setTimeout(n,i);t.addEventListener(()=>{clearTimeout(s),r(b.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function sl(t){if(!(t instanceof P)||!t.customData)return!1;const e=Number(t.customData.httpStatus);return e===429||e===500||e===503||e===504}class ol{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function al(t,e,n,r,i){if(i&&i.global){t("event",n,r);return}else{const s=await e,o=Object.assign(Object.assign({},r),{send_to:s});t("event",n,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cl(){if(yt())try{await vt()}catch(t){return v.warn(b.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return v.warn(b.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function ll(t,e,n,r,i,s,o){var a;const c=rl(t);c.then(f=>{n[f.measurementId]=f.appId,t.options.measurementId&&f.measurementId!==t.options.measurementId&&v.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${f.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(f=>v.error(f)),e.push(c);const l=cl().then(f=>{if(f)return r.getId()}),[u,h]=await Promise.all([c,l]);Xc(s)||zc(s,u.measurementId),i("js",new Date);const g=(a=o==null?void 0:o.config)!==null&&a!==void 0?a:{};return g[Bc]="firebase",g.update=!0,h!=null&&(g[Fc]=h),i("config",u.measurementId,g),u.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ul{constructor(e){this.app=e}_delete(){return delete de[this.app.options.appId],Promise.resolve()}}let de={},En=[];const Tn={};let ot="dataLayer",dl="gtag",An,Wr,Sn=!1;function hl(){const t=[];if(It()&&t.push("This is a browser extension environment."),Mn()||t.push("Cookies are not available."),t.length>0){const e=t.map((r,i)=>`(${i+1}) ${r}`).join(" "),n=b.create("invalid-analytics-context",{errorInfo:e});v.warn(n.message)}}function fl(t,e,n){hl();const r=t.options.appId;if(!r)throw b.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)v.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw b.create("no-api-key");if(de[r]!=null)throw b.create("already-exists",{id:r});if(!Sn){qc(ot);const{wrappedGtag:s,gtagCore:o}=Yc(de,En,Tn,ot,dl);Wr=s,An=o,Sn=!0}return de[r]=ll(t,En,Tn,e,An,ot,n),new ul(t)}function pl(t=Bn()){t=A(t);const e=se(t,Me);return e.isInitialized()?e.getImmediate():gl(t)}function gl(t,e={}){const n=se(t,Me);if(n.isInitialized()){const i=n.getImmediate();if(he(e,n.getOptions()))return i;throw b.create("already-initialized")}return n.initialize({options:e})}async function ml(){if(It()||!Mn()||!yt())return!1;try{return await vt()}catch{return!1}}function _l(t,e,n,r){t=A(t),al(Wr,de[t.app.options.appId],e,n,r).catch(i=>v.error(i))}const Rn="@firebase/analytics",kn="0.10.0";function Il(){N(new C(Me,(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return fl(r,i,n)},"PUBLIC")),N(new C("analytics-internal",t,"PRIVATE")),S(Rn,kn),S(Rn,kn,"esm2017");function t(e){try{const n=e.getProvider(Me).getImmediate();return{logEvent:(r,i,s)=>_l(n,r,i,s)}}catch(n){throw b.create("interop-component-reg-failed",{reason:n})}}}Il();const yl={apiKey:"AIzaSyDCDzDcaol4b5mQvYUCKl2fpQHmXxwpNPk",authDomain:"habitscroll-b4ccb.firebaseapp.com",projectId:"habitscroll-b4ccb",storageBucket:"habitscroll-b4ccb.firebasestorage.app",messagingSenderId:"861547233127",appId:"1:861547233127:web:769503666f785c6e9df9c2",measurementId:"G-E4JKCFNJFW"},zr=Fn(yl),ae=Ba(zr),vl=async()=>await ml()?pl(zr):null;console.log("Firebase initialized");const wl=_.createContext(void 0);function bl({children:t}){const[e,n]=_.useState(null),[r,i]=_.useState(!0),{toast:s}=Qr();_.useEffect(()=>(console.log("Setting up auth state listener"),So(ae,g=>{console.log("Auth state changed:",g?"User authenticated":"No user"),n(g),i(!1)})),[]);const u={currentUser:e,loading:r,login:async(h,g)=>{try{console.log("Attempting login with:",h);const f=await Eo(ae,h,g);return console.log("Login successful"),s({title:"Login successful",description:"You've been successfully logged in",duration:3e3}),f.user}catch(f){console.error("Login error:",f.code,f.message);let y="Failed to login";throw f.code==="auth/user-not-found"||f.code==="auth/wrong-password"?y="Invalid email or password":f.code==="auth/too-many-requests"&&(y="Too many unsuccessful login attempts. Please try again later."),s({title:"Login Error",description:y,variant:"destructive",duration:5e3}),f}},signup:async(h,g)=>{try{console.log("Attempting signup with:",h);const f=await bo(ae,h,g);return console.log("Signup successful"),s({title:"Account created",description:"Your account has been created successfully",duration:3e3}),f.user}catch(f){console.error("Signup error:",f.code,f.message);let y="Failed to create an account";throw f.code==="auth/email-already-in-use"?y="Email already in use":f.code==="auth/weak-password"?y="Password is too weak":f.code==="auth/invalid-email"&&(y="Invalid email address"),s({title:"Registration Error",description:y,variant:"destructive",duration:5e3}),f}},logout:async()=>{try{await Ro(ae),s({title:"Logged out",description:"You've been successfully logged out",duration:3e3})}catch(h){throw s({title:"Logout Error",description:"There was a problem logging you out",variant:"destructive",duration:5e3}),h}},resetPassword:async h=>{try{await wo(ae,h),s({title:"Password Reset Email Sent",description:"Check your email for password reset instructions",duration:5e3})}catch(g){let f="Failed to send password reset email";throw g.code==="auth/user-not-found"?f="No account found with that email":g.code==="auth/invalid-email"&&(f="Invalid email address"),s({title:"Reset Password Error",description:f,variant:"destructive",duration:5e3}),g}}};return console.log("Auth Provider rendering, loading:",r),p.jsx(wl.Provider,{value:u,children:t})}const El=_.lazy(()=>E(()=>import("./Index-DC0sqVUV.js"),__vite__mapDeps([0,1,2,3,4]),import.meta.url)),Tl=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.L),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Al=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.a),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Sl=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.b),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Rl=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.I),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),kl=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.D),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Cl=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.c),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Pl=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.B),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Ol=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.d),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Dl=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.A),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Nl=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.V),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Ll=_.lazy(()=>E(()=>import("./pages-CgsJvD3g.js").then(t=>t.K),__vite__mapDeps([5,2,1,3,4]),import.meta.url)),Ml=()=>p.jsx("div",{className:"flex items-center justify-center min-h-screen bg-retro-dark",children:p.jsx("div",{className:"text-retro-purple-200 font-pixel text-xl animate-pulse",children:"Loading..."})});function Ul(){return console.log("App component rendering"),p.jsx(Gr,{children:p.jsx(bl,{children:p.jsx(Zr,{children:p.jsxs(Jr,{children:[p.jsx(_.Suspense,{fallback:p.jsx(Ml,{}),children:p.jsxs(Yr,{children:[p.jsx(w,{path:"/",element:p.jsx(El,{})}),p.jsx(w,{path:"/learn-who-you-are",element:p.jsx(Tl,{})}),p.jsx(w,{path:"/learn-about-habits",element:p.jsx(Al,{})}),p.jsx(w,{path:"/learn-how-to-track",element:p.jsx(Sl,{})}),p.jsx(w,{path:"/impressum",element:p.jsx(Rl,{})}),p.jsx(w,{path:"/datenschutz",element:p.jsx(kl,{})}),p.jsx(w,{path:"/deploy",element:p.jsx(Cl,{})}),p.jsx(w,{path:"/blog",element:p.jsx(Pl,{})}),p.jsx(w,{path:"/bookworms",element:p.jsx(Ol,{})}),p.jsx(w,{path:"/audiophiles",element:p.jsx(Dl,{})}),p.jsx(w,{path:"/visual-learners",element:p.jsx(Nl,{})}),p.jsx(w,{path:"/knowledge-seekers",element:p.jsx(Ll,{})}),p.jsx(w,{path:"*",element:p.jsx(ti,{})})]})}),p.jsx(ei,{})]})})})})}if(typeof window<"u"&&"performance"in window&&(window.performance.mark("app-init"),"PerformanceObserver"in window))try{new PerformanceObserver(e=>{for(const n of e.getEntries())n.duration>50&&console.debug("Long task detected:",n)}).observe({entryTypes:["longtask"]})}catch{console.debug("PerformanceObserver for longtask not supported")}const xl=()=>{const t=sessionStorage.getItem("redirectPath");t&&(console.log("Redirected from:",t),sessionStorage.removeItem("redirectPath"))};vl().then(t=>{console.debug(t?"Firebase Analytics initialized successfully":"Firebase Analytics not supported in this environment")}).catch(t=>{console.error("Error initializing Firebase Analytics:",t)});const Fl=()=>{"requestIdleCallback"in window&&window.requestIdleCallback(()=>{const t=["./pages/LearnWhoYouAre","./pages/LearnAboutHabits","./pages/LearnHowToTrack"];Promise.all(t.map(e=>import(e).catch(n=>console.debug(`Prefetch failed for ${e}:`,n))))})};(async()=>{try{xl(),Xr(document.getElementById("root")).render(p.jsx(Ul,{})),window.performance.mark("app-rendered"),window.performance.measure("app-render-time","app-init","app-rendered"),Fl()}catch(t){console.error("Error rendering application:",t)}})();window.addEventListener("DOMContentLoaded",()=>{window.performance.mark("dom-content-loaded"),window.performance.measure("dom-load-time","app-init","dom-content-loaded")});window.addEventListener("load",()=>{window.performance.mark("page-load-complete"),window.performance.measure("total-page-load","app-init","page-load-complete");const t=window.performance.getEntriesByName("total-page-load")[0];t&&console.debug(`Page fully loaded in: ${Math.round(t.duration)}ms`)});
